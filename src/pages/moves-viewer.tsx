		...
		return (
			<div style={{ textAlign: 'center' }}>
				...
				<p style={{ textDecoration: 'underline' }}>
					{this.state.path ? `選択中[${this.state.path}]` : '未選択'}
				</p>
							...
							<L.LayerGroup>
								{this.moves.walking.map(walking => {
									return (
										<L.Polyline
											key={walking.type}
											positions={walking.latlng}
											color={walking.color}
											opacity={walking.opacity}
										/>
									)
								})}
							</L.LayerGroup>
							...
							<L.LayerGroup>
								{this.moves.transport.map(transport => {
									return (
										<L.Polyline
											key={transport.type}
											positions={transport.latlng}
											color={transport.color}
											opacity={transport.opacity}
										/>
									)
								})}
							</L.LayerGroup>
